...
<body class="bg-white font-sans text-stone-800 selection:bg-green-200 selection:text-green-950">
    ...
    <nav aria-label="Navegação principal"
        ...
        <div class="mx-auto flex h-20 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6">
            <a href="#inicio"
                ...
                <span>
                    ...
                    <span class="mt-1 hidden text-xs font-medium tracking-wide text-stone-500 sm:block">Ação
                        ambiental</span>
                </span>
            </a>
            ...
            <div class="hidden items-center gap-1 md:flex">
                <a href="#problema"
                    class="rounded-lg px-3 py-2 text-sm font-medium text-stone-600 transition hover:bg-green-50 hover:text-green-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">O
                    Problema</a>
                <a href="#solucao"
                    class="rounded-lg px-3 py-2 text-sm font-medium text-stone-600 transition hover:bg-green-50 hover:text-green-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">A
                    Solução</a>
                <a href="#impacto"
            ...
            <button id="navigation-toggle" type="button"
                ...
                aria-controls="mobile-navigation" aria-expanded="false" aria-label="Abrir menu">
                <svg data-menu-icon class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7h16M4 12h16M4 17h16" />
                </svg>
                <svg data-close-icon class="hidden size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    aria-hidden="true">
        ...
        <div id="mobile-navigation" class="hidden border-t border-stone-200 bg-white px-4 py-4 shadow-lg md:hidden">
            <div class="mx-auto grid max-w-6xl gap-1">
                <a href="#problema"
                    class="rounded-lg px-3 py-3 font-medium text-stone-700 transition hover:bg-green-50 hover:text-green-800 focus-visible:outline-2 focus-visible:outline-green-600">O
                    Problema</a>
                <a href="#solucao"
                    class="rounded-lg px-3 py-3 font-medium text-stone-700 transition hover:bg-green-50 hover:text-green-800 focus-visible:outline-2 focus-visible:outline-green-600">A
                    Solução</a>
                <a href="#impacto"
    ...
    <section id="inicio" class="relative scroll-mt-24 pt-24 pb-0">
        <div class="relative h-[70vh] overflow-hidden">
            <img src="{{ asset('attached_assets/br/hero_dirty.jpg') }}" alt="Rua brasileira com lixo e entulho"
            ...
            <div class="absolute right-0 bottom-0 left-0 p-8 text-white md:p-16">
                <div class="max-w-4xl">
                    ...
                    <p class="mb-8 max-w-2xl text-xl text-stone-200">Milhares de toneladas de resíduos são descartados
                        irregularmente todos os dias nas ruas, estradas e terrenos do Brasil.</p>
                    <a href="#solucao"
        ...
        <div class="mx-auto max-w-6xl">
            <div class="mb-16 text-center">
                ...
                <h2 class="text-3xl font-bold lg:text-4xl">
                    Caminhos bloqueados pelo descaso
                </h2>
            </div>
            ...
            <div class="grid gap-8 md:grid-cols-3">
                ...
                <figure>
                    <div class="relative aspect-4/3 overflow-hidden">
                        <img src="{{ asset('attached_assets/br/real_bh.jpg') }}"
                            alt="Descarte irregular em Belo Horizonte MG" class="h-full w-full object-cover" />
                        <div class="absolute inset-0 bg-linear-to-t from-black/60 to-transparent"></div>
                        <span
                            class="absolute bottom-3 left-3 text-sm font-semibold tracking-wide text-white uppercase">Belo
                            Horizonte, MG</span>
                    </div>
                    <figcaption class="mt-3 text-sm leading-snug text-stone-400">
                        BH registrou mais de 2.000 denúncias de descarte
                        incorreto em 2026. Moradores e comerciantes sofrem com
                        acúmulo de lixo em vias públicas.<br />
                        <a href="https://bhaz.com.br/noticias/bh/descarte-incorreto-lixo-bh-2026/" target="_blank"
                            class="mt-1 inline-block text-stone-500 underline underline-offset-2 hover:text-green-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400">BHaz
                            — Descarte incorreto de lixo em BH registrou
                            mais de 2 mil denúncias ↗</a>
                    </figcaption>
                </figure>
                ...
                <figure>
                    <div class="relative aspect-4/3 overflow-hidden">
                        <img src="{{ asset('attached_assets/br/real_mg.png') }}"
                            alt="Estrada vira lixão em Águas Formosas, próximo a Novo Cruzeiro MG"
                            class="h-full w-full object-cover" />
                        <div class="absolute inset-0 bg-linear-to-t from-black/60 to-transparent"></div>
                        <span
                            class="absolute bottom-3 left-3 text-sm font-semibold tracking-wide text-white uppercase">Águas
                            Formosas, MG</span>
                    </div>
                    <figcaption class="mt-3 text-sm leading-snug text-stone-400">
                        Trecho da estrada entre Novo Cruzeiro e Teófilo Otoni
                        (Vale do Mucuri). Moradores denunciam acúmulo de lixo às
                        margens da via.<br />
                        <a href="https://jornaldiarioteo.com.br/estrada-vira-lixao-em-aguas-formosas/" target="_blank"
                            class="mt-1 inline-block text-stone-500 underline underline-offset-2 hover:text-green-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400">Diário
                            de Teófilo Otoni — Estrada vira lixão em
                            Águas Formosas ↗</a>
                    </figcaption>
                </figure>
                ...
                <figure>
                    <div class="relative aspect-4/3 overflow-hidden">
                        <img src="{{ asset('attached_assets/br/real_vdc_1.jpg') }}"
                            alt="Descarte irregular em Vitória da Conquista, Bahia"
                            class="h-full w-full object-cover" />
                        <div class="absolute inset-0 bg-linear-to-t from-black/60 to-transparent"></div>
                        <span
                            class="absolute bottom-3 left-3 text-sm font-semibold tracking-wide text-white uppercase">Vitória
                            da Conquista, BA</span>
                    </div>
                    <figcaption class="mt-3 text-sm leading-snug text-stone-400">
                        Sofás, colchões e resíduos domésticos descartados em
                        calçadas e áreas verdes da cidade.<br />
                        <a href="https://www.blogdoanderson.com/2026/04/18/lixour/" target="_blank"
                            class="mt-1 inline-block text-stone-500 underline underline-offset-2 hover:text-green-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400">Blog
                            do Anderson — Descarte irregular cria "lixões
                            urbanos" em Vitória da Conquista ↗</a>
                    </figcaption>
                </figure>
            </div>
    ...
    <section id="solucao" class="relative scroll-mt-24 py-0">
        <div class="relative h-[70vh] overflow-hidden">
            <img src="{{ asset('attached_assets/br/solucao_estrada.jpg') }}" alt="Estrada limpa no Brasil"
                class="h-full w-full object-cover" />
            ...
            <div class="absolute right-0 bottom-0 left-0 p-8 text-white md:p-16">
                <div class="max-w-4xl">
                    ...
                    <p class="max-w-2xl text-xl text-stone-200">O <strong>Caminho Limpo</strong> trabalha para
                        transformar essa realidade através de coleta responsável, educação ambiental e ação comunitária.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="bg-green-50 px-6 py-20">
        <div class="mx-auto max-w-6xl">
            <div class="mb-16 text-center">
                ...
                <h2 class="text-3xl font-bold text-stone-900 lg:text-4xl">
                    Como limpamos o caminho
                </h2>
            </div>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-xl bg-white p-6 shadow-xs">
                    ...
                    <p class="text-sm text-stone-600">Identificamos pontos críticos de descarte irregular na cidade.
                    </p>
                </div>
    ...
    <section class="px-6 py-20">
        <div class="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
            <div>
                <img src="{{ asset('attached_assets/br/voluntarios.jpg') }}" alt="Voluntários limpando ruas no Brasil"
                    class="aspect-4/3 w-full rounded-xl object-cover shadow-lg" />
            </div>
            <div>
                <p class="mb-3 font-medium text-green-600">Ação Comunitária</p>
                <h2 class="mb-6 text-3xl font-bold text-stone-900 lg:text-4xl">
                    Juntos, limpamos o caminho.
                </h2>
                <p class="mb-6 leading-relaxed text-stone-600">Nossos voluntários já realizaram mais de <strong>50
                        mutirões</strong> de limpeza em bairros, estradas e áreas verdes. Cada ação remove toneladas de
                    lixo e transforma a paisagem urbana.</p>
    ...
    <section id="impacto" class="scroll-mt-24 bg-stone-50 px-6 py-20">
        <div class="mx-auto max-w-6xl">
            <div class="mb-16 text-center">
                ...
                <h2 class="text-3xl font-bold text-stone-900 lg:text-4xl">
                    Cada caminho limpo faz a diferença
                </h2>
            </div>

            <div class="grid items-center gap-8 md:grid-cols-2">
                <div>
                    <img src="{{ asset('attached_assets/br/impacto_limpo.jpg') }}" alt="Rua limpa no Brasil"
                        class="aspect-4/3 w-full rounded-xl object-cover shadow-lg" />
                </div>
                <div class="space-y-6">
                    <div class="rounded-xl bg-white p-6 shadow-xs">
    ...
    <section id="contato" class="scroll-mt-24 bg-green-700 px-6 py-20 text-white">
        <div class="mx-auto max-w-3xl text-center">
            <h2 class="mb-6 text-3xl font-bold lg:text-4xl">
                O caminho limpo começa com você.
            </h2>
            <p class="mb-10 text-lg text-green-100">Seja voluntário, denuncie pontos de descarte irregular ou apoie
                nossa causa. Cada ação conta.</p>
            <div class="flex flex-col justify-center gap-4 sm:flex-row">
                <a href="mailto:contato@caminholimpo.org"
